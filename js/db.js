  ...
  seed() {
    ...
    const menuItems = [
     ...
     // { name: 'Kuzhambu Appam',          category: 'Breakfast',  price: 65,  type: 'veg',     description: 'Appam served with a rich tangy kuzhambu curry.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: false },
      ...
      // ─── MEALS & RICE ───
      { name: 'Veg Meals',        category: 'Meals & Rice', price: 120, type: 'veg',     description: 'Full South Indian veg thali with rice, sambar, rasam, kootu and payasam.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTCe_2PJ6v1EgLfmPe4Dm1akNzBaAFauRIDCsw5RehQoFysitqTIdIEAgU&s=10', popular: true  },
      { name: 'Non-Veg Meals',    category: 'Meals & Rice', price: 200, type: 'non-veg', description: 'Full South Indian non-veg thali with curries, rice and accompaniments.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-qRCNJ7IH2vEOlzndiiL8ZT2etHW5ItG1IuvXm2v7HA&s=10', popular: false },
      { name: 'Mini Meals',       category: 'Meals & Rice', price: 80,  type: 'veg',     description: 'A smaller portion thali — ideal for a light lunch.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT73j_6hX1yJ9T6G1LAJL01IhbJ3hnZC_N56hqsOcLyVA&s=10', popular: false },
      { name: 'Special Meals',    category: 'Meals & Rice', price: 180, type: 'veg',     description: 'Premium thali with extra items including sweets and special curries.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzGOqnOiadpBWetnwC_QRR9bhrlQAX7MPt2cEMGKHTCw&s=10', popular: false },
      { name: 'Sambhar Rice',     category: 'Meals & Rice', price: 80,  type: 'veg',     description: 'Rice mixed with hot, tangy sambar — simple and comforting.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSNusB9I1wnjax4kJXtHT566axi5W3juUiPLeJD-xPOQ&s=10', popular: false },
      { name: 'Tomato Rice',      category: 'Meals & Rice', price: 70,  type: 'veg',     description: 'Rice cooked with ripe tomatoes, mustard seeds and South Indian spices.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGNPwvJeQm5JZTLIfvvJsFPJ19DyAiaHb5Od4gmAW_8g&s=10', popular: false },
      { name: 'Lemon Rice',       category: 'Meals & Rice', price: 70,  type: 'veg',     description: 'Bright and tangy rice with lemon juice, turmeric and peanuts.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAzUkWew4LmJZY40CMhxtMBhscaaU3rXR2OxJFmJrsGA&s=10', popular: false },
      { name: 'Curd Rice',        category: 'Meals & Rice', price: 70,  type: 'veg',     description: 'Cooling curd rice tempered with mustard, curry leaves and pomegranate.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8yy1O9_DetLbWkEIGf6UnyDn2mloVEErXYRVmZG60IQ&s=10', popular: false },
      { name: 'Coconut Rice',     category: 'Meals & Rice', price: 70,  type: 'veg',     description: 'Rice tossed with freshly grated coconut and fried cashews.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvFysUI6h3ClCLf7gQMund_sHyXOCgDwgKm7lkS8CgYw&s=10', popular: false },
      { name: 'Tamarind Rice',    category: 'Meals & Rice', price: 70,  type: 'veg',     description: 'Tangy tamarind-spiced rice with groundnuts and sesame.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSesxNE3vBZczGMQXAHzhCOcM0IbFNp2cmELoU033qHCQ&s=10', popular: false },
