...
const DB = {
  ...
  seed() {
    ...
    const menuItems = [
      ...
      { name: 'Onion Roast Dosa',        category: 'Breakfast',  price: 65,  type: 'veg',     description: 'Extra crispy roast dosa layered with caramelized onions.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: false },
      ...
      { name: 'Podi Roast Dosa',         category: 'Breakfast',  price: 75,  type: 'veg',     description: 'Ultra crispy roast dosa smothered in aromatic gun powder.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: false },
      { name: 'Ghee Podi Roast Dosa',    category: 'Breakfast',  price: 90,  type: 'veg',     description: 'Premium roast dosa with both ghee and podi for extra flavour.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: false },
      { name: 'Onion Ghee Podi Roast',   category: 'Breakfast',  price: 100, type: 'veg',     description: 'The ultimate combination — onion, ghee, and podi on a roast dosa.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: false },
      ...
      { name: 'Egg Roast Dosa',          category: 'Breakfast',  price: 85,  type: 'non-veg', description: 'Crispy roast dosa topped with a spicy egg preparation.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: true  },
      { name: 'Egg Onion Roast',         category: 'Breakfast',  price: 95,  type: 'non-veg', description: 'Roast dosa with egg and caramelized onions.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: false },
      ...
      { name: 'Tomato Uttapam',          category: 'Breakfast',  price: 65,  type: 'veg',     description: 'Soft uttapam with fresh tomato slices and green chillies on top.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: false },
      { name: 'Butter Uttapam',          category: 'Breakfast',  price: 75,  type: 'veg',     description: 'Golden uttapam cooked with fresh butter for richness.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: false },
      { name: 'Onion Ghee Uttapam',      category: 'Breakfast',  price: 85,  type: 'veg',     description: 'Uttapam with onions, drizzled with ghee for extra aroma.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: false },
      { name: 'Onion Ghee Podi Uttapam', category: 'Breakfast',  price: 95,  type: 'veg',     description: 'Premium uttapam with onion, ghee and aromatic podi masala.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: false },
      { name: 'Egg Uttapam',             category: 'Breakfast',  price: 80,  type: 'non-veg', description: 'Thick uttapam with egg cooked right into the pancake.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: false },
      { name: 'Mini Onion Dosa',         category: 'Breakfast',  price: 50,  type: 'veg',     description: 'Set of mini dosas with caramelized onion topping — perfect for sharing.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: false },
      ...
      { name: 'Kuzhambu Appam',          category: 'Breakfast',  price: 65,  type: 'veg',     description: 'Appam served with a rich tangy kuzhambu curry.', image: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=400&q=80', popular: false },
      ...
      { name: 'Hyderabadi Chicken Biryani',   category: 'Biryani', price: 310, type: 'non-veg', description: 'Dum-cooked Hyderabadi-style biryani with whole spices and fried onions.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400&q=80', popular: false },
      { name: 'Hyderabadi Mutton Biryani',    category: 'Biryani', price: 380, type: 'non-veg', description: 'Authentic Hyderabadi mutton dum biryani with saffron and rose water.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400&q=80', popular: false },
      { name: 'Ambur Chicken Biryani',        category: 'Biryani', price: 290, type: 'non-veg', description: 'Fragrant small-grain rice biryani from Ambur, tangy and spiced uniquely.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400&q=80', popular: false },
      { name: 'Ambur Mutton Biryani',         category: 'Biryani', price: 360, type: 'non-veg', description: 'Classic Ambur mutton biryani with Seeraga Samba rice and bold spices.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400&q=80', popular: false },
      { name: 'Dindigul Chicken Biryani',     category: 'Biryani', price: 290, type: 'non-veg', description: 'Signature Dindigul-style with cube-cut chicken and pepper-forward spicing.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400&q=80', popular: false },
      { name: 'Dindigul Mutton Biryani',      category: 'Biryani', price: 360, type: 'non-veg', description: 'Tender Dindigul mutton biryani with distinctly peppery aroma.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400&q=80', popular: false },
      { name: 'Chettinad Chicken Biryani',    category: 'Biryani', price: 300, type: 'non-veg', description: 'Robustly spiced Chettinad biryani with kalpasi and marathi mokku.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400&q=80', popular: false },
      { name: 'Chettinad Mutton Biryani',     category: 'Biryani', price: 370, type: 'non-veg', description: 'Rich Chettinad mutton biryani bursting with rare spices.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400&q=80', popular: false },
      { name: 'Thalappakatti Chicken Biryani',category: 'Biryani', price: 310, type: 'non-veg', description: 'The famous Thalappakatti-style with Seeraga Samba rice and tender chicken.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400&q=80', popular: false },
      { name: 'Thalappakatti Mutton Biryani', category: 'Biryani', price: 380, type: 'non-veg', description: 'Legendary Thalappakatti mutton biryani, slow-cooked to perfection.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400&q=80', popular: false },
      ...
      { name: 'Nattu Kozhi Biryani',          category: 'Biryani', price: 340, type: 'non-veg', description: 'Country chicken (nattu kozhi) biryani with deep, rustic flavours.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400&q=80', popular: false },
      { name: 'Turkey Biryani',               category: 'Biryani', price: 400, type: 'non-veg', description: 'Premium turkey biryani — a rare and indulgent special.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400&q=80', popular: false },
      ...
      { name: 'Mixed Non-Veg Biryani',        category: 'Biryani', price: 380, type: 'non-veg', description: 'A lavish biryani with chicken, mutton, and egg all together.', image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400&q=80', popular: false },
      ...
      // ─── MEALS & RICE ───
      { name: 'Veg Meals',        category: 'Meals & Rice', price: 120, type: 'veg',     description: 'Full South Indian veg thali with rice, sambar, rasam, kootu and payasam.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: true  },
      { name: 'Non-Veg Meals',    category: 'Meals & Rice', price: 200, type: 'non-veg', description: 'Full South Indian non-veg thali with curries, rice and accompaniments.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Chicken Meals',    category: 'Meals & Rice', price: 220, type: 'non-veg', description: 'Thali with rice, chicken curry, rasam and sides.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Mutton Meals',     category: 'Meals & Rice', price: 260, type: 'non-veg', description: 'Thali with rice, mutton gravy, rasam and traditional sides.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Fish Meals',       category: 'Meals & Rice', price: 240, type: 'non-veg', description: 'Thali with rice, fish curry, rasam and chutneys.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Mini Meals',       category: 'Meals & Rice', price: 80,  type: 'veg',     description: 'A smaller portion thali — ideal for a light lunch.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Special Meals',    category: 'Meals & Rice', price: 180, type: 'veg',     description: 'Premium thali with extra items including sweets and special curries.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Sambhar Rice',     category: 'Meals & Rice', price: 80,  type: 'veg',     description: 'Rice mixed with hot, tangy sambar — simple and comforting.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Tomato Rice',      category: 'Meals & Rice', price: 70,  type: 'veg',     description: 'Rice cooked with ripe tomatoes, mustard seeds and South Indian spices.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Lemon Rice',       category: 'Meals & Rice', price: 70,  type: 'veg',     description: 'Bright and tangy rice with lemon juice, turmeric and peanuts.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Curd Rice',        category: 'Meals & Rice', price: 70,  type: 'veg',     description: 'Cooling curd rice tempered with mustard, curry leaves and pomegranate.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Coconut Rice',     category: 'Meals & Rice', price: 70,  type: 'veg',     description: 'Rice tossed with freshly grated coconut and fried cashews.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Tamarind Rice',    category: 'Meals & Rice', price: 70,  type: 'veg',     description: 'Tangy tamarind-spiced rice with groundnuts and sesame.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Rasam Rice',       category: 'Meals & Rice', price: 70,  type: 'veg',     description: 'Soothing pepper rasam mixed into rice — the best comfort food.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Plain Rice',       category: 'Meals & Rice', price: 40,  type: 'veg',     description: 'Simple steamed white rice served with your choice of curry.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      { name: 'Vegetable Pulao',  category: 'Meals & Rice', price: 130, type: 'veg',     description: 'Aromatic basmati pulao with mixed vegetables and whole spices.', image: 'https://images.unsplash.com/photo-1546833998-877b37c2e5c6?w=400&q=80', popular: false },
      ...
      { name: 'Coca Cola',       category: 'Cold Drinks', price: 40, type: 'veg', description: 'Classic Coca-Cola can — ice cold and refreshing.', image: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=400&q=80', popular: false },
      { name: 'Pepsi',           category: 'Cold Drinks', price: 40, type: 'veg', description: 'Bold Pepsi cola served chilled.', image: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=400&q=80', popular: false },
      { name: 'Sprite',          category: 'Cold Drinks', price: 40, type: 'veg', description: 'Crisp, lemon-lime Sprite — perfect thirst quencher.', image: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=400&q=80', popular: false },
      { name: 'Fanta',           category: 'Cold Drinks', price: 40, type: 'veg', description: 'Fizzy orange Fanta — sweet and refreshing.', image: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=400&q=80', popular: false },
      { name: '7UP',             category: 'Cold Drinks', price: 40, type: 'veg', description: 'Clear lemon-lime 7UP with a clean, crisp taste.', image: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=400&q=80', popular: false },
      { name: 'Mountain Dew',    category: 'Cold Drinks', price: 40, type: 'veg', description: 'Energizing citrus Mountain Dew — bold and intense.', image: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=400&q=80', popular: false },
      { name: 'Limca',           category: 'Cold Drinks', price: 40, type: 'veg', description: 'Tangy lemon-lime Limca — a classic Indian fizzy drink.', image: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=400&q=80', popular: false },
      { name: 'Thums Up',        category: 'Cold Drinks', price: 40, type: 'veg', description: 'Strong cola flavour with a bold, fizzy punch.', image: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=400&q=80', popular: false },
      ...
      // ─── LASSI ───
      { name: 'Sweet Lassi',  category: 'Lassi', price: 70,  type: 'veg', description: 'Chilled thick yoghurt blended with sugar and cardamom.', image: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=400&q=80', popular: false },
      { name: 'Mango Lassi',  category: 'Lassi', price: 90,  type: 'veg', description: 'Creamy yoghurt blended with sweet Alphonso mango pulp.', image: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=400&q=80', popular: false },
      { name: 'Rose Lassi',   category: 'Lassi', price: 80,  type: 'veg', description: 'Yoghurt lassi flavoured with rose syrup and crushed pistachios.', image: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=400&q=80', popular: false },
      { name: 'Badam Lassi',  category: 'Lassi', price: 100, type: 'veg', description: 'Thick lassi enriched with almond paste and saffron strands.', image: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=400&q=80', popular: false },
      ...
      // ─── WATER ───
      { name: 'Mineral Water 500ml', category: 'Water', price: 20, type: 'veg', description: 'Chilled mineral water in a 500ml bottle.', image: '', popular: false },
      { name: 'Mineral Water 1L',    category: 'Water', price: 30, type: 'veg', description: 'Still mineral water in a 1 litre bottle.', image: '', popular: false },
      { name: 'Soda',                category: 'Water', price: 25, type: 'veg', description: 'Chilled plain soda water — ideal mixer or light refresher.', image: '', popular: false },
    ];
